...
public class MsgOpDelete {
    ...
    public static MsgOpDelete create(long requestId, String collection,
                                      Document condition, Document hint, int flags) {
        MsgOpDelete msg = new MsgOpDelete();
        msg.header = MsgHeader.newRequest(OpCode.DELETE_REQ, requestId);
        msg.version = 1;
        msg.w = 1;
        msg.flags = flags;
    ...
    public static MsgOpDelete decode(MsgHeader header, byte[] payload) {
